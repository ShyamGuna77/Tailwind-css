      ...
      <div className="mt-16 container max-w-6xl px-6">
        <div>
          <div className="flex flex-col justify-between md:flex-row">
            <p className="font-mono uppercase font-light text-3xl text-center">
              Our creations
            </p>
            <button className="border border-black px-8 py-2 text-black bg-white hover:bg-black hover:text-white">
              SEE ALL
            </button>
          </div>
        </div>
